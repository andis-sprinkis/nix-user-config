...
ms('MouseRight-MouseMiddle-ScrollUp', nop)
ms('MouseRight-MouseMiddle-ScrollDown', nop)
ms('MouseMiddle-ScrollLeft', nop)
ms('MouseMiddle-ScrollRight', nop)
ms('MouseMiddle-ScrollUp', nop)
ms('MouseMiddle-ScrollDown', nop)
ms('MouseLeft-ScrollLeft', nop)
ms('MouseLeft-ScrollRight', nop)
ms('MouseLeft-ScrollUp', nop)
ms('MouseLeft-ScrollDown', nop)
