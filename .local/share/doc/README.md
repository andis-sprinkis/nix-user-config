...
- [Arch Linux setup](./linux_install.md)
    - [Applications that require manual installation](./linux_manual_app_install.md)
...
- [Web browsers setup](./web_browser_setup.md)
    - [Configuring _Firefox Multi-Account Containers_ for site session isolation](./ff_addon_multiaccountcontainers.md)
